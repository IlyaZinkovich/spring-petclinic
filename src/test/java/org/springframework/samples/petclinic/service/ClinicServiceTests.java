 ...
 * state, there is no need for a teardown or cleanup script. <li> An {@link
 * org.springframework.context.ApplicationContext ApplicationContext} is also inherited and can be
 * used for explicit bean lookup if necessary. </li> </ul>
 *
 * @author Ken Krebs
 * @author Rod Johnson
